...
def Ufunc_(elm : T_STR, T : T_UNION[T_ARRAY,T_FLOAT,T_INT]) -> T_UNION[T_ARRAY,T_FLOAT]:
    ...
    if   elm == 'H_I':
        ...
        c = (_numpy.log10(6), 0., 0., 0., 0.)  # ufunc1 = 6.0   # Allen, 197
    elif elm == 'Mg_I':
        ...
        c = (_numpy.log10(21), 0., 0., 0., 0.)  # ufunc = 21
    elif elm == 'Ba_I':
        ...
        raise ValueError(f'{elm}: partition function is not defined!')
